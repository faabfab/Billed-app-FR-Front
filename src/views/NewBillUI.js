            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <span id="format_error" class="format_error_hide" data-testid ="format_error">Le document doit être jpg, jpeg ou png</span>
                  </div> 
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' class="btn btn-primary" data-testid="new-bill-submit">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
